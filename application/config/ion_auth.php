...
*/
$config['tables']['users']           = 'BI_USERS';
$config['tables']['groups']          = 'BI_GROUPS';
$config['tables']['users_groups']    = 'BI_USERS_GROUPS';
$config['tables']['login_attempts']  = 'BI_LOGIN_ATTEMPS';
 ...
 */
$config['site_title']                 = "biteste.mocassim.com.br";       // Site Title, example.com
$config['admin_email']                = "victorhcezario@gmail.com"; // Admin Email, admin@example.com
